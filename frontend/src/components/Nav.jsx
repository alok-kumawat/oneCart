    ...
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>
        ...
        <div className='w-[30%] flex items-center justify-end gap-[20px]'>
            ...
            {showSearch && <div className='w-[100%] h-[80px] bg-[#d8f6f9dd] absolute top-[100%] left-0 right-0 flex items-center justify-center'>
                <input type="text" className='lg:w-[50%] w-[70%] h-[60%] bg-[#233533] rounded-[30px] px-[50px] placeholder:text-white text-[white] text-[18px]' placeholder='Search...' onChange={(e)=>{setSearch(e.target.value)}} value={search}/>
            </div>}
        ...
        <div className='w-[100vw] h-[90px] flex items-center justify-between px-[20px] text-[13px] fixed bottom-0 left-0 bg-[#191818] md:hidden'>
            ...
            <p className='absolute w-[18px] h-[18px] flex items-center justify-center bg-white px-[5px] py-[2px] text-black font-semibold rounded-full text-[9px] top-[10px] right-[15px]'>{getCartCount()}</p>
        </div>
