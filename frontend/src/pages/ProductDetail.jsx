...
const ProductDetail = () => {
  ...
  return productData ? (
    <div>
        <div className='lg:w-[98.8vw] w-[100vw] h-[130vh] md:h-[100vh] flex items-center justify-start flex-col lg:flex-row bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px]'>
            <div className='lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
                <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-col flex-wrap'>
                    <div className='md:w-[91px] w-[50px] h-[50px] md:h-[93px] bg-slate-300 border-[1px] border-[#80808049] rounded-md'>
            ...
            <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
                <h1 className='text-[39px] font-semibold text-[aliceblue]'>{productData.name.toUpperCase()}</h1>
                <div className='flex items-center gap-1'>
                    ...
                    <p className='text-[17px] font-semibold pl-[5px] text-[white]'>(69)</p>
                </div>
                <p className='text-[29px] font-semibold pl-[5px] text-[white]'>{currency} {productData.price}</p>
                <p className='w-[80%] md:w-[60%] text-[19px] font-semibold pl-[5px] text-[white]'>{productData.description}</p>
                <div className='flex flex-col gap-[10px] my-[10px]'>
                    <p className='text-[25px] font-semibold pl-[5px] text-[white]'>Select Size</p>
                    <div className='flex gap-2'>
                        {
                            productData.sizes.map((item, index) =>(
                                <button key={index} className={`border py-2 px-4 bg-slate-300 rounded-md ${item === size ? 'bg-black text-[#2f97f1] text-[19px]' : ''}`} onClick={() => setSize(item)}>{item}</button>
                            ))
                        }
                    </div>
                ...
                <div className='w-[80%] text-[15px] text-white'>
        ...
        <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden'>
            ...
            <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
                <p className='w-[95%] h-[90%] flex items-center justify-center'>
                    Upgrade your wardrobe with this stylish product, that is now available on OneCart. Crafted from breadthable, high-quality fabric, it offers all-day comfort and effortless style. Easy to maintain and perfect for any setting, this product is a must-have essentail for those who value both fashion and function.
                </p>
            </div>
