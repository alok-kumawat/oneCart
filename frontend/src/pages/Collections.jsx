...
const Collections = () => {
  ...
  return (
    <div className='w-[98.8vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] pb-[110px] overflow-x-hidden z-[2]'>
        <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] ${showFilter ? "h-[95vh]" : "h-[8vh]"} p-[20px] border-r-[1px] border-gray-400 text-[#aaf5fa] lg:fixed`}> {/*h-[51vh]*/}
            ...
            <div className={`border-[2px] border-[#dededc] pl-5 py-3 mt-6 rounded-md bg-slate-600 ${showFilter ? "" : "hidden"} md:block`}>
            ...
            <div className={`border-[2px] border-[#dededc] pl-5 py-3 mt-6 rounded-md bg-slate-600 ${showFilter ? "" : "hidden"} md:block`}>
                ...
                <div className='w-[230px] h-[150px] flex items-start justify-center gap-[10px] flex-col'>
                    ...
                    <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'> <input type="checkbox" value={'SummerWear'} className='w-3' onChange={toggleSubCategory}/> SummerWear</p>
                </div>
            </div>
        </div>
        <div className='lg:pl-[20%] md:py-[10px]'>
            <div className='md:w-[80vw] w-[100vw] p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]'>
                ...
                <select name="" id="" className='bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-[white] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e)=>setSortType(e.target.value)}>
                    <option value="relavent" className='w-[100%] h-[100%]'>Relavent</option>
